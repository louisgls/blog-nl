...
class NewsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('blogBundle:News')->findAll();

        return $this->render('blogBundle:News:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
 ...
 */
    public function createAction(Request $request)
    {
        ...
        return $this->render('blogBundle:News:new.html.twig', array(
            'entity' => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('blogBundle:News:edit.html.twig', array(
            'entity'      => $entity,
